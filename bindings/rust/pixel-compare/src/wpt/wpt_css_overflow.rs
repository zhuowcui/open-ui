...
fn css_overflow_clip_005_ref() -> Document {
    ...
    doc.node_mut(n1).style.outline_color = StyleColor::Resolved(Color::from_rgba8(128, 128, 128, 255));
    doc.append_child(vp, n1);
        let n2 = doc.create_node(ElementTag::Div);
        doc.node_mut(n2).style.display = Display::Block;
        doc.node_mut(n2).style.margin_top = Length::px(0.0);
    ...
    doc.node_mut(n3).style.outline_color = StyleColor::Resolved(Color::from_rgba8(128, 128, 128, 255));
    doc.append_child(vp, n3);
        let n4 = doc.create_node(ElementTag::Div);
        doc.node_mut(n4).style.display = Display::Block;
        doc.node_mut(n4).style.margin_top = Length::px(0.0);
    ...
    doc.node_mut(n5).style.outline_color = StyleColor::Resolved(Color::from_rgba8(128, 128, 128, 255));
    doc.append_child(vp, n5);
        let n6 = doc.create_node(ElementTag::Div);
        doc.node_mut(n6).style.display = Display::Block;
        doc.node_mut(n6).style.margin_top = Length::px(0.0);
...
pub fn css_overflow_registry() -> Vec<(&'static str, fn() -> Document)> {
    vec![
        ...
        ("wpt/css_overflow/margin-block-end-scroll-area-001", css_overflow_margin_block_end_scroll_area_001 as fn() -> Document),
        ...
        ("wpt/css_overflow/line-clamp_continue-001", css_overflow_line_clamp_continue_001 as fn() -> Document),
        ...
        ("wpt/css_overflow/line-clamp_discard_discard-multicol-001", css_overflow_line_clamp_discard_discard_multicol_001 as fn() -> Document),
        ("wpt/css_overflow/line-clamp_discard_discard-multicol-002", css_overflow_line_clamp_discard_discard_multicol_002 as fn() -> Document),
        ("wpt/css_overflow/line-clamp_discard_discard-multicol-003", css_overflow_line_clamp_discard_discard_multicol_003 as fn() -> Document),
        ("wpt/css_overflow/line-clamp_discard_discard-multicol-004", css_overflow_line_clamp_discard_discard_multicol_004 as fn() -> Document),
        ...
        ("wpt/css_overflow/scroll-markers_scroll-buttons-001-ref", css_overflow_scroll_markers_scroll_buttons_001_ref as fn() -> Document),
        ...
        ("wpt/css_overflow/scroll-markers_scroll-marker-group-001-ref", css_overflow_scroll_markers_scroll_marker_group_001_ref as fn() -> Document),
        ("wpt/css_overflow/scroll-markers_scroll-marker-group-005-ref", css_overflow_scroll_markers_scroll_marker_group_005_ref as fn() -> Document),
        ("wpt/css_overflow/scroll-markers_scroll-marker-group-006-ref", css_overflow_scroll_markers_scroll_marker_group_006_ref as fn() -> Document),
