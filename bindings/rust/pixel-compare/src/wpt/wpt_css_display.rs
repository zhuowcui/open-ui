...
pub fn css_display_registry() -> Vec<(&'static str, fn() -> Document)> {
    vec![
        ...
        ("wpt/css_display/display-contents-suppression-dynamic-001-ref", css_display_display_contents_suppression_dynamic_001_ref as fn() -> Document),
        ...
        ("wpt/css_display/display-contents-text-only-001-ref", css_display_display_contents_text_only_001_ref as fn() -> Document),
        ("wpt/css_display/display-contents-text-only-001", css_display_display_contents_text_only_001 as fn() -> Document),
