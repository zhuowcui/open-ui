...
pub fn css_box_registry() -> Vec<(&'static str, fn() -> Document)> {
    vec![
        (
            "wpt/css_box/margin-trim_block-container-non-adjoining-item-ref",
            css_box_margin_trim_block_container_non_adjoining_item_ref as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-block-end-trimmed-only-ref",
            css_box_margin_trim_flex_block_end_trimmed_only_ref as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-block-start-trimmed-only-ref",
            css_box_margin_trim_flex_block_start_trimmed_only_ref as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-block-trimmed-only-ref",
            css_box_margin_trim_flex_block_trimmed_only_ref as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-column-inline-multiline-ref",
            css_box_margin_trim_flex_column_inline_multiline_ref as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-column-style-change-triggers-layout-block-end-ref",
            css_box_margin_trim_flex_column_style_change_triggers_layout_block_end_ref
                as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-column-style-change-triggers-layout-block-ref",
            css_box_margin_trim_flex_column_style_change_triggers_layout_block_ref
                as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-column-style-change-triggers-layout-block-start-ref",
            css_box_margin_trim_flex_column_style_change_triggers_layout_block_start_ref
                as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-inline-end-trimmed-only-ref",
            css_box_margin_trim_flex_inline_end_trimmed_only_ref as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-inline-start-trimmed-only-ref",
            css_box_margin_trim_flex_inline_start_trimmed_only_ref as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-inline-trimmed-only-ref",
            css_box_margin_trim_flex_inline_trimmed_only_ref as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-row-block-multiline-ref",
            css_box_margin_trim_flex_row_block_multiline_ref as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-row-style-change-triggers-layout-inline-end-ref",
            css_box_margin_trim_flex_row_style_change_triggers_layout_inline_end_ref
                as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-row-style-change-triggers-layout-inline-ref",
            css_box_margin_trim_flex_row_style_change_triggers_layout_inline_ref
                as fn() -> Document,
        ),
        (
            "wpt/css_box/margin-trim_flex-row-style-change-triggers-layout-inline-start-ref",
            css_box_margin_trim_flex_row_style_change_triggers_layout_inline_start_ref
                as fn() -> Document,
        ),
        (
