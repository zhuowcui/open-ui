...
const char* oui_sk_status_string(OuiSkStatus status) {
  switch (status) {
    case OUI_SK_OK:
      return "OK";
    case OUI_SK_ERROR_INVALID_ARGUMENT:
      return "Invalid argument";
    case OUI_SK_ERROR_NULL_POINTER:
      return "Null pointer";
    case OUI_SK_ERROR_OUT_OF_MEMORY:
      return "Out of memory";
    case OUI_SK_ERROR_GPU_INIT_FAILED:
      return "GPU initialization failed";
    case OUI_SK_ERROR_SURFACE_CREATION_FAILED:
      return "Surface creation failed";
    case OUI_SK_ERROR_ENCODE_FAILED:
      return "Encode failed";
    case OUI_SK_ERROR_DECODE_FAILED:
      return "Decode failed";
    case OUI_SK_ERROR_FILE_NOT_FOUND:
      return "File not found";
    case OUI_SK_ERROR_FONT_NOT_FOUND:
      return "Font not found";
    case OUI_SK_ERROR_BACKEND_NOT_AVAILABLE:
      return "Backend not available";
    case OUI_SK_ERROR_WINDOW_CREATION_FAILED:
      return "Window creation failed";
    case OUI_SK_ERROR_UNKNOWN:
